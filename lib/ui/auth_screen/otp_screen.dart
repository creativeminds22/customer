                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text("Verify Phone Number", style: GoogleFonts.poppins(fontWeight: FontWeight.w600, fontSize: 18)),
                        ),
                        Padding(
                          padding: const EdgeInsets.only(top: 2),
                          child: Text("We just send a verification code to \n${controller.countryCode.value + controller.phoneNumber.value}", style: GoogleFonts.poppins()),
                        ),
                        Padding(
                                    ...
                                    if (userExit == true) {
                                      ...
                                      if (userModel != null) {
                                        if (userModel.isActive == true) {
                                          ...
                                          ShowToastDialog.showToast("This user is disable please contact administrator");
                                        }
                                      }
                                    } else {
                                      UserModel userModel = UserModel();

...
class Paypal {
  ...
  Paypal.fromJson(Map<String, dynamic> json) {
    braintreePrivatekey = json['braintree_privatekey'];
    braintreeTokenizationKey = json['braintree_tokenizationKey'];
    paypalpassword = json['paypalpassword'];
    paypalUserName = json['paypalUserName'];
    enable = json['enable'];
    paypalAppId = json['paypalAppId'];
    name = json['name'];
    paypalSecret = json['paypalSecret'];
    braintreePublickey = json['braintree_publickey'];
    isSandbox = json['isSandbox'];
    braintreeMerchantid = json['braintree_merchantid'];
  }

  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = <String, dynamic>{};
    data['braintree_privatekey'] = braintreePrivatekey;
    data['braintree_tokenizationKey'] = braintreeTokenizationKey;
    data['paypalpassword'] = paypalpassword;
    data['paypalUserName'] = paypalUserName;
    data['enable'] = enable;
    data['paypalAppId'] = paypalAppId;
    data['name'] = name;
    data['paypalSecret'] = paypalSecret;
    data['braintree_publickey'] = braintreePublickey;
    data['isSandbox'] = isSandbox;
    data['braintree_merchantid'] = braintreeMerchantid;
    return data;
  }
}
